        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Link
              ...
              className={`text-sm font-semibold px-4 py-2 rounded-lg transition-colors border ${
                pathname.startsWith("/blog")
                  ? "text-white bg-zinc-700 border-zinc-600 shadow-sm"
                  : "text-zinc-200 bg-zinc-800/80 border-zinc-700 hover:text-white hover:bg-zinc-700"
              }`}
            >
              Blog
            </Link>
            ...
            <a
              ...
              className="hidden sm:inline-flex items-center gap-1.5 text-sm font-semibold px-4 py-2 rounded-lg text-zinc-200 bg-zinc-800/80 border border-zinc-700 hover:text-white hover:bg-zinc-700 transition-colors"
            >
